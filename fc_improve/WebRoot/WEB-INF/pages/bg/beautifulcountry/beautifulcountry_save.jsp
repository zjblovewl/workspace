...
<div style="padding:10px 0 10px 60px">
    <form id="saveform" method="post" action="beautifulCountry/save.htm" enctype="multipart/form-data">
    ...
    <input type="hidden" name="action" value="${action}">
    	<table width="95%">
		    		...
		    		<tr>
		    			<td width="10%" nowrap="nowrap">标签:</td>
		    			<td>
		    				<input class="easyui-validatebox crm-input" maxlength="32" value="${bean.label}" type="text" style="width:200px;" name="label"  id="label" validType=""></input>
		    			</td>
		    		</tr>
		    		...
		    		<tr>
		    			...
		    			<td>
		    				<input class="crm-input" type="text"  disabled="disable" title="${bean.imagePath }" value="文件名" id="upfileinnerThree">
		    				<script type="text/javascript">
		    					var imagepath = '${bean.imagePath}';
		    					...
		    					if(imagepath!=''){
		    						...
		    						$("#downloadImage").show();
		    						$("#upfileinnerThree").val(imagepath);
		    						$("#downloadImage").attr('href',path+imagepath);
		    					}
		    				</script>
							<div class="a-upload">
							  <input type="file" name="upFileInnerThird" onchange="document.getElementById('upfileinnerThree').value=this.value" ><span style="color: black;">浏览...</span>
							</div>
							
							<div class="a-upload" id="downloadImageDiv" style="margin-left: 15px;display: none;">
							  <a href="" id="downloadImage" style="display: none;">下载图片</a>
							</div>

...
<div style="padding:10px 0 10px 60px">
    <form id="saveform" method="post" action="goodThings/save.htm" enctype="multipart/form-data">
    ...
    <input type="hidden" name="action" value="${action}">
    	<table width="95%">
		    		...
		    		<tr>
		    			...
		    			<td>
		    				<input class="crm-input" type="text"  disabled="disable" value="文件名" title="${accessoryPath }" id="upfileinnerOne">

 ...
 */
public interface IGoodPersionService
{
     ...
     * @return 新增是否成功
     */
    boolean insert( GoodPerson goodPerson,HttpServletRequest request );
     ...
     * @return 更新是否成功
     */
    boolean updateById(  GoodPerson goodPerson,HttpServletRequest request  );

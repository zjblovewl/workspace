 ...
 * @since  [产品/模块版本]
 */
public interface IImpressSouthService
{
     ...
     * @return 新增是否成功
     */
    boolean insert( ImpressSouth cr,HttpServletRequest request );
     ...
     * @return 更新是否成功
     */
    boolean updateById( ImpressSouth cr,HttpServletRequest request  );

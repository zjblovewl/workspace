 ...
 */
public interface IThingReportService
{
     ...
     * @return 查询的分页对象
     */
    Pager listUserReports( int pageNumber, int pageSize, List<SearchCondition> conditions );
     ...
     * @return 新增是否成功
     */
    boolean insert( ThingReport thingReport );
     ...
     * @return 更新是否成功
     */
    boolean updateById(  ThingReport thingReport  );
    
    Map<String,String> getCompanyInfo(String userId);

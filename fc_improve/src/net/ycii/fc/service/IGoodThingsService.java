 ...
 */
public interface IGoodThingsService
{
     ...
     * @return 新增是否成功
     */
    boolean insert( GoodThings goodThings,HttpServletRequest request );
     ...
     * @return 更新是否成功
     */
    boolean updateById(  GoodThings goodThings,HttpServletRequest request  );
